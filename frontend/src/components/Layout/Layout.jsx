...
const GRUPOS_MENU = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/compras/obsequios-pendientes', icon: '🔍', label: 'Ítems por revisar', permiso: 'compras.gestionar', modulo: 'comprasHabilitadas' },
    ],
  },
  {
    id: 'inventario',
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/configuracion/sucursales',   icon: '🏬', label: 'Sucursales y Puntos de Venta', permiso: 'sucursales.gestionar', modulo: 'sucursalesHabilitado' },
