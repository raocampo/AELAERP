...
const menuPublicoRoutes           = require('./routes/menuPublico');
const comprobantesPublicosRoutes  = require('./routes/comprobantesPublicos');
...
app.use('/api/menu-publico', menuPublicoRoutes);
app.use('/api/comprobantes-publicos', comprobantesPublicosRoutes);
